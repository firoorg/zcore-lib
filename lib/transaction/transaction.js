...
Transaction.prototype.toBufferWriter = function(writer, noWitness) {
  writer.writeInt32LE(this.version | (this.type << 16));
...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  if(this.version == 3 && this.type != 0) {
    var extraPayloadSize = reader.readVarintNum();
    this.cbTx = {};
    this.cbTx.version = reader.readUInt16LE();
    this.cbTx.height = reader.readInt32LE();
    // This was disabled as this is already done in insight-api-zcoin/lib/transaction.js
    // this.cbTx.merkleRootMNList = reader.readReverse(32).toString('hex');
    // if(this.cbTx.version >= 2) {
    //   this.cbTx.merkleRootQuorums = reader.readReverse(32).toString('hex');
    // }
  }
  return this;
};
